/**
 * commit-storage-charges-shadow - live-shadow handler for the GAS `commitStorageRows (commitStorageCharges)` action.
...
export function runCommitStorageChargesShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runCommitStorageChargesShadow(payload);
