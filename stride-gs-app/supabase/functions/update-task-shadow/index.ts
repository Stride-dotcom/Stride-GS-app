/**
 * update-task-shadow - live-shadow handler for the GAS `updateTaskNotes/Priority/DueDate/CustomPrice (updateTask)` action.
...
export function runUpdateTaskShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runUpdateTaskShadow(payload);
