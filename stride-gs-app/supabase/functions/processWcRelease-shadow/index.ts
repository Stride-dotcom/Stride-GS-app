/**
 * processWcRelease-shadow - live-shadow handler for the GAS `processWcRelease` action.
...
export function runProcessWcReleaseShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runProcessWcReleaseShadow(payload);
