/**
 * send-task-complete-email-shadow - live-shadow handler for the GAS `sendTaskCompleteEmail` action.
...
export function runSendTaskCompleteEmailShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runSendTaskCompleteEmailShadow(payload);
