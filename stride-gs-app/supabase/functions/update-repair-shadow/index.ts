/**
 * update-repair-shadow - live-shadow handler for the GAS `updateRepairNotes (updateRepair)` action.
...
export function runUpdateRepairShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runUpdateRepairShadow(payload);
