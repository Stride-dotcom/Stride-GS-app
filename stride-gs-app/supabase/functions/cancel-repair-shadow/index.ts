...
// passes. Without OPTIONS handling + ACAH listing the custom headers that
// supabase-js attaches (apikey, authorization, x-client-info), the browser
// blocks the POST and supabase-js surfaces "Failed to send a request to the
// Edge Function" — the request never reaches us. Mirrors update-item-sb.
const corsHeaders = {
