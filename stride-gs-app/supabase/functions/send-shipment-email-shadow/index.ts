/**
 * send-shipment-email-shadow - live-shadow handler for the GAS `sendShipmentEmail` action.
...
export function runSendShipmentEmailShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runSendShipmentEmailShadow(payload);
