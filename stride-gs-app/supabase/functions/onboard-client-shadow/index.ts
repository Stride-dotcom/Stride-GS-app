/**
 * onboard-client-shadow - live-shadow handler for the GAS `onboardClient` action.
...
export function runOnboardClientShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runOnboardClientShadow(payload);
