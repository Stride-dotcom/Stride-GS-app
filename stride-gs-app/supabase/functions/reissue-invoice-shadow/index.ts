/**
 * reissue-invoice-shadow - live-shadow handler for the GAS `reissueInvoice` action.
...
export function runReissueInvoiceShadow(payload: Payload): ShadowResult {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const result = runReissueInvoiceShadow(payload);
