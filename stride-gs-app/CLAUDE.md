...
This app uses: React + TypeScript + Vite + TanStack Table. No Supabase, no RLS, no SALA.
...
**Next:** Production testing and user feedback. See root `CLAUDE.md` performance track section for Phase 3 candidates.
