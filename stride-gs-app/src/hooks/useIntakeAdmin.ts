...
export interface IntakeRow {
  ...
  /** Prospect opted into Stride auto-inspecting every inbound shipment
   *  for visible shipping damage. Off by default; copied into the
   *  client's AUTO_INSPECTION setting at activation. */
  autoInspect: boolean;
