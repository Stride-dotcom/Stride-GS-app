...
export default function App() {
  ...
  // policies on dt_orders + dt_order_items gate the inserts to
  // source='public_form' / review_status='pending_review' (see
  // migration 20260426220000_dt_orders_public_form_anon_insert.sql).
