/* ===================================================
   ...
   v4.8.1: getDefaultDocHtml_ — DOC_RECEIVING, DOC_TASK_WORK_ORDER,
           ...
           <td> and width="40%" align="right" on the title <td>. The
           HTML→Google-Doc converter was splitting the widthless 2-col
           header 50/50 and centering the inner logo block, pushing the
           "Stride Logistics WMS" name into the middle of the page on the
           Receiving / Will Call / Task Work Order PDFs. Mirrors
           StrideAPI.gs v38.125.0 fallback fix for DOC_TASK_WORK_ORDER.
