...
BEGIN
  ...
  -- Guard split-task executions for idempotency:
  -- if this split_task_id already created children for this parent, return them instead of mutating again.
  ...
  FOR i IN 0..(p_leftover_qty - 1) LOOP
    ...
    INSERT INTO public.items (
      id, tenant_id, account_id, item_code, item_name, item_description,
    ...
    VALUES (
      ...
      v_parent.item_name, v_parent.item_description,
